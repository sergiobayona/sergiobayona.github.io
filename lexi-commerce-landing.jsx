...
const LexiCommerceLanding = () => {
  ...
  const content = {
    es: {
      ...
      features: {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'OAuth 2.1, encriptación AES-256-GCM y aislamiento multi-tenant. Tus datos están protegidos.',
            benefit: 'Certificado'
          },
          {
            icon: TrendingUp,
      ...
      howItWorks: {
        title: '¿Cómo Funciona?',
        subtitle: 'De webhook a respuesta en menos de 2 segundos',
        steps: [
          {
            number: '01',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="px-6 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg hover:shadow-lg transition font-medium">
                {t.hero.cta}
              </button>
            </div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-xl transition text-lg font-semibold flex items-center justify-center">
                {t.hero.cta}
                <ChevronRight className="ml-2 w-5 h-5" />
              </button>
              <button className="px-8 py-4 bg-white text-slate-700 rounded-xl border-2 border-slate-200 hover:border-blue-600 transition text-lg font-semibold">
                {t.hero.ctaSecondary}
              </button>
            </div>
      ...
      <section id="pricing" className="py-20 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-12 border border-blue-100">
            ...
            <button className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:shadow-xl transition text-lg font-semibold flex items-center justify-center">
              {t.pricing.cta}
              <ChevronRight className="ml-2 w-5 h-5" />
            </button>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-cyan-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="px-12 py-5 bg-white text-blue-600 rounded-xl hover:shadow-2xl transition text-xl font-bold inline-flex items-center">
            {t.cta.button}
